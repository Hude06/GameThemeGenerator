...
let Theme = ["Cuberfunk", "Romance", "Prehistoric", "Nature", "Islands","Ancient Civilization","Underground","Medical","Space Travel"]
...
function random_item(items){
    return Theme[Math.floor(Math.random()*items.length)];    
}
GenreElement.innerHTML = random_item(Genre);
ThemeElement.innerHTML = random_item(Theme);
MechanicElement.innerHTML = random_item(Mechanic);
